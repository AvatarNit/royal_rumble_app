     ...
     <main className="mentor-container">
      ...
      <header className="mentor-header">
        ...
        <div style={{ display: "flex", flexDirection: "row", alignItems: "center",
          ...
          <h3 className="mentor-subtitle2"> Hallway Host</h3>
        </div>
      </header>
      ...
      <section className="mentor-info-box" style={{ display: "flex", gap: "30px", alignItems: "flex-start" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: "20px", margin: "30px" }}>
          <MentorButtons link="/mentor/hallway_host/group_details">Group Details</MentorButtons>
          <MentorButtons link="/mentor/hallway_host/group_attendance">Attendance</MentorButtons>
        </div>
